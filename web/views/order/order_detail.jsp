<%@ page import="com.east.furns.pojo.OrderItem" %>
            ...
            <div class="row align-self-center">
                ...
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="views/customer/index.jsp"><img src="assets/images/logo/logo.png" alt="Site Logo"/></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                <!-- Header Action Start -->
    ...
    <div class="header-bottom d-lg-none sticky-nav bg-white">
        <div class="container position-relative">
            <div class="row align-self-center">
                ...
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="views/customer/index.jsp"><img width="280px" src="assets/images/logo/logo.png"
                                                                alt="Site Logo"/></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="cart-shiping-update-wrapper">
                                <h4>共${orderItemTotalCount}件商品 总价${order.price}元</h4>
