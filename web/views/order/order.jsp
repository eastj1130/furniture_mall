    ...
    <div class="header-bottom d-lg-none sticky-nav bg-white">
        <div class="container position-relative">
            <div class="row align-self-center">
                ...
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="views/customer/index.jsp"><img width="280px" src="assets/images/logo/logo.png" alt="Site Logo"/></a>
                    </div>
                </div>
                <!-- Header Logo End -->
            </div>
				...
				<th>订单</th>
                            ...
                            <tr>
                                ...
                                <td class="product-remove">
                                    <a href="customer/orderItemServlet?action=orderItemList&orderId=${order.id}"><i class="icon-eye"></i></a>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
