        ...
        $(function () {
            $("#sub-btn").click(function (event){
                ...
                if (!usernameReg.test(username)){
                    $(".errorMsg").text("请输入6-10位的用户名");
                    event.preventDefault();
                }else {
                    let passwordReg = /^[a-zA-Z0-9]{6,10}$/;
                    let password = $("#password").val();
                    if (!passwordReg.test(password)){
                        $(".errorMsg").text("请输入6-10位的密码");
                        event.preventDefault();
                    }else {
                        let repwd = $("#repwd").val();
                        if (repwd!=password){
            ...
            if ("${active}"==="register"){
                alert($("#memeberRegiser"));
                $("#memeberRegiser")[0].click();
            }
            ...
            <div class="col-lg-7 col-md-12 ml-auto mr-auto">
                <div class="login-register-wrapper">
                    <div class="login-register-tab-list nav">
                        ...
                        <a data-bs-toggle="tab" href="#lg2" id="memeberRegiser">
                            <h4>会员注册</h4>
                        </a>
                    </div>
                    <div class="tab-content">
                        <div id="lg1" class="tab-pane active">
                            <div class="login-form-container">
                                ...
                                <h2 class="login-error" style="text-align: center; color: red">
                                    ${login_error}
                                </h2>
                                <%--登陆界面--%>
                                ...
                                <div class="login-register-form">
                                    ...
                                    <form action="memberServlet" method="post">
                                        ...
                                        <input type="text" id="code" name="code" style="width: 50%" id="code"
                                               placeholder="验证码"/>　　<img alt="" src="kaptchaServlet" id="codeImg">
                                        <div class="button-box">
