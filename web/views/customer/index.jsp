<%@ page import="com.east.furns.pojo.Cart" %>
                    ...
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <form class="action-form" action="customer/customerFurniture" method="post">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="${furniture.imgPath}"
                                                     alt="Product"/>
                                            </a>
                                            <span class="badges">
                                        ...
                                        <div class="content">
                                            ...
                                            <span class="price">
                                                <span class="new">厂商:　${furniture.maker}</span>
                                            </span>
                                            <span class="price">
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        <li><a href="${furniturePage.url}&pageNo=1&pageSize=4">首页</a></li>
        ...
        <c:forEach begin="${beginPage}" end="${endPage}" var="i">
            ...
            <c:if test="${furniturePage.pageNo!=i}">
                <li><a href="${furniturePage.url}&pageNo=${i}&pageSize=4">${i}</a></li>
            </c:if>
        </c:forEach>

        <c:if test="${furniturePage.pageNo!=furniturePage.totalPage}">
            <li>
                <a href="${furniturePage.url}&pageNo=${furniturePage.pageNo+1}&pageSize=4">下页</a>
            </li>
        </c:if>
