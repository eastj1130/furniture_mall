                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="product-name"><input name="name" style="width: 60%" type="text" value="${furniture.name}"/></td>
                                <td class="product-name"><input name="maker" style="width: 90%" type="text" value="${furniture.maker}"/></td>
                                <td class="product-price-cart"><input name="price" style="width: 90%" type="text" value="${furniture.price}"/></td>
                                <td class="product-quantity">
                                    <input name="sales" style="width: 90%" type="text" value="${furniture.sales}"/>
                                </td>
                                <td class="product-quantity">
                                    <input name="stock" style="width: 90%" type="text" value="${furniture.stock}"/>
                                </td>
                                <td>
